...
**Z-GENESIS-AAAK** è modulo Z-GENESIS per compressione, sintesi e organizzazione di conoscenza operativa.
...
| Area | Dettaglio |
|---|---|
| Repository | high-cde/Z-GENESIS-AAAK |
| Visibilità | Pubblico |
| Tecnologia principale | Python |
| Ruolo | Modulo Z-GENESIS per compressione, sintesi e organizzazione di conoscenza operativa. |
