...
**Z-GENESIS-LIVE** è interfaccia live JavaScript per osservare e controllare componenti Z-GENESIS.
...
| Area | Dettaglio |
|---|---|
| Repository | high-cde/Z-GENESIS-LIVE |
| Visibilità | Pubblico |
| Tecnologia principale | JavaScript/Node.js |
| Ruolo | Interfaccia live JavaScript per osservare e controllare componenti Z-GENESIS. |
