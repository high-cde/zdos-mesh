# Overview tecnica: Z-GENESIS Live

## Scopo

Interfaccia live JavaScript per osservare e controllare componenti Z-GENESIS. Questa overview definisce il contesto operativo del repository, il suo ruolo nell'ecosistema e le convenzioni minime da seguire durante l'evoluzione del progetto.
...
|---|---|
| Identità | `high-cde/Z-GENESIS-LIVE` |
