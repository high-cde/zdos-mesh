# Overview tecnica: Z-GENESIS Palace

## Scopo

Sistema di memoria strutturata Z-GENESIS basato su livelli, stanze e archivi semantici. Questa overview definisce il contesto operativo del repository, il suo ruolo nell'ecosistema e le convenzioni minime da seguire durante l'evoluzione del progetto.
...
|---|---|
| Identità | `high-cde/Z-GENESIS-PALACE` |
