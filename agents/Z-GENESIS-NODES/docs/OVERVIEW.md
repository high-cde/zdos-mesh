# Overview tecnica: Z-GENESIS Nodes

## Scopo

Agenti Python remoti per distribuire nodi Z-GENESIS su VPS, Kali, Termux e ambienti Linux. Questa overview definisce il contesto operativo del repository, il suo ruolo nell'ecosistema e le convenzioni minime da seguire durante l'evoluzione del progetto.
...
|---|---|
| Identità | `high-cde/Z-GENESIS-NODES` |
