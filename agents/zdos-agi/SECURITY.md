...
Questa policy riguarda il repository `high-cde/zdos-agi` e la relativa documentazione. Il progetto può includere script, automazioni, componenti sperimentali o integrazioni con sistemi esterni; per questo motivo ogni utilizzo deve avvenire in ambienti autorizzati e controllati.
