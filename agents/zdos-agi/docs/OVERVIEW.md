# Overview tecnica: ZDOS Agi

## Scopo

Spazio di integrazione per componenti AGI-oriented nell'ecosistema ZDOS. Questa overview definisce il contesto operativo del repository, il suo ruolo nell'ecosistema e le convenzioni minime da seguire durante l'evoluzione del progetto.
