# Overview tecnica: Z-GENESIS Cli

## Scopo

CLI shell per comandare, inizializzare e orchestrare moduli Z-GENESIS. Questa overview definisce il contesto operativo del repository, il suo ruolo nell'ecosistema e le convenzioni minime da seguire durante l'evoluzione del progetto.
...
|---|---|
| Identità | `high-cde/Z-GENESIS-CLI` |
