...
**Z-GENESIS-CLI** è cLI shell per comandare, inizializzare e orchestrare moduli Z-GENESIS.
...
| Area | Dettaglio |
|---|---|
| Repository | high-cde/Z-GENESIS-CLI |
| Visibilità | Pubblico |
| Tecnologia principale | Shell/Linux |
| Ruolo | CLI shell per comandare, inizializzare e orchestrare moduli Z-GENESIS. |
