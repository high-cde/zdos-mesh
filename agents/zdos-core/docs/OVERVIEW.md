# Overview tecnica: ZDOS Core

## Scopo

Nucleo concettuale dell'ecosistema ZDOS, destinato a raccogliere specifiche, moduli base e convenzioni architetturali. Questa overview definisce il contesto operativo del repository, il suo ruolo nell'ecosistema e le convenzioni minime da seguire durante l'evoluzione del progetto.
