...
**zdos-core** è nucleo concettuale dell'ecosistema ZDOS, destinato a raccogliere specifiche, moduli base e convenzioni architetturali.
...
| Area | Dettaglio |
|---|---|
| Repository | high-cde/zdos-core |
| Visibilità | Pubblico |
| Tecnologia principale | Documentazione e architettura modulare |
| Ruolo | Nucleo concettuale dell'ecosistema ZDOS, destinato a raccogliere specifiche, moduli base e convenzioni architetturali. |
...
| Fase | Comando |
|---|---|
| Clone | `git clone https://github.com/high-cde/zdos-core.git` |
| Esplorazione | `ls -la` |
