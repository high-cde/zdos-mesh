...
**zdos-site** è sito ufficiale e hub documentale dell'ecosistema ZDOS.
...
| Area | Dettaglio |
|---|---|
| Repository | high-cde/zdos-site |
| Visibilità | Pubblico |
| Tecnologia principale | Documentazione e architettura modulare |
| Ruolo | Sito ufficiale e hub documentale dell'ecosistema ZDOS. |
...
| Fase | Comando |
|---|---|
| Clone | `git clone https://github.com/high-cde/zdos-site.git` |
| Esplorazione | `ls -la` |
