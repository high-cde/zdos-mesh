# Overview tecnica: Bridgechain.Zmod

## Scopo

Modulo BridgeChain per ZDOS, pensato per standardizzare componenti bridge, integrazione e distribuzione modulare. Questa overview definisce il contesto operativo del repository, il suo ruolo nell'ecosistema e le convenzioni minime da seguire durante l'evoluzione del progetto.
...
|---|---|
| Identità | `high-cde/BridgeChain.zmod` |
