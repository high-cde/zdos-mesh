# Overview tecnica: ZDOS Discord Bot

## Scopo

Bot Discord per l'ecosistema ZDOS-DISCORD-OPENCLAW Questa overview definisce il contesto operativo del repository, il suo ruolo nell'ecosistema e le convenzioni minime da seguire durante l'evoluzione del progetto.
...
|---|---|
| Identità | `high-cde/zdos-discord-bot` |
