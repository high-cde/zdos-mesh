...
**Z-GENESIS-CORTEX** è motore cognitivo centrale di Z-GENESIS, dedicato a orchestrazione, API e routing dei moduli.
...
| Area | Dettaglio |
|---|---|
| Repository | high-cde/Z-GENESIS-CORTEX |
| Visibilità | Pubblico |
| Tecnologia principale | Python |
| Ruolo | Motore cognitivo centrale di Z-GENESIS, dedicato a orchestrazione, API e routing dei moduli. |
...
| Fase | Comando |
|---|---|
| Ambiente virtuale | `python3 -m venv .venv && source .venv/bin/activate` |
| Installazione dipendenze | `pip install -r requirements.txt` |
| Esecuzione | `python3 main.py` |
