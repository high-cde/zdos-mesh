# Overview tecnica: Z-GENESIS Cortex

## Scopo

Motore cognitivo centrale di Z-GENESIS, dedicato a orchestrazione, API e routing dei moduli. Questa overview definisce il contesto operativo del repository, il suo ruolo nell'ecosistema e le convenzioni minime da seguire durante l'evoluzione del progetto.
...
|---|---|
| Identità | `high-cde/Z-GENESIS-CORTEX` |
