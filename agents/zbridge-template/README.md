...
**zbridge-template** è template TypeScript per creare moduli ZBridge coerenti con l'architettura ZDOS.
...
| Area | Dettaglio |
|---|---|
| Repository | high-cde/zbridge-template |
| Visibilità | Pubblico |
| Tecnologia principale | TypeScript |
| Ruolo | Template TypeScript per creare moduli ZBridge coerenti con l'architettura ZDOS. |
