# Overview tecnica: Zbridge Template

## Scopo

Template TypeScript per creare moduli ZBridge coerenti con l'architettura ZDOS. Questa overview definisce il contesto operativo del repository, il suo ruolo nell'ecosistema e le convenzioni minime da seguire durante l'evoluzione del progetto.
...
|---|---|
| Identità | `high-cde/zbridge-template` |
| Tecnologia principale | TypeScript |
